# 🎨 Shadcn/UI Dialog for Weweb

Beautiful **Dialog component** from [shadcn/ui](https://ui.shadcn.com/) adapted for Weweb.

## 🚀 Import in Weweb

1. Copy this repository URL: `https://github.com/YOUR_USERNAME/shadcn-dialog`
2. In Weweb editor, open developer panel (F12)
3. Add as "custom element"
4. The Dialog component will appear in your elements!
